...
void AProjectilePool::SpawnProjectile(FVector SpanwLocation, FRotator SpawnRotation, bool bIsActive /*= false*/) {
	AProjectile* projectile = GetWorld()->SpawnActor<AProjectile>(ProjectileClass, SpanwLocation, SpawnRotation);
